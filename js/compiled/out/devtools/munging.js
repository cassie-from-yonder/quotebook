...
var o21982 = temp__5718__auto__;
var temp__5718__auto____$1 = (o21982["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o21983 = temp__5718__auto____$1;
return (o21983["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__21309__auto___21986 = t;
(o__21309__auto___21986["cljs$lang$ctorPrWriter"]).call(o__21309__auto___21986,t,writer);
}catch (e21985){var __21987 = e21985;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21988 = num_code;
switch (G__21988) {
case (1):
return (185);
...
}catch (e21990){var _e__21316__auto__ = e21990;
return false;
}})())){
...
var vec__21991 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21991,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o21994 = temp__5718__auto__;
var temp__5718__auto____$1 = (o21994["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o21995 = temp__5718__auto____$1;
return (o21995["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21998){
var vec__21999 = p__21998;
var ns_detector = cljs.core.nth.call(null,vec__21999,(0),null);
...
var G__22005 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22006 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22005;
remaining_tokens = G__22006;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21996){
...
var vec__22010 = cljs.core.split_with.call(null,(function (p1__22009_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22009_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22010,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22010,(1),null);
...
var vec__22016 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22016,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22016,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22019 = cljs.core.rest.call(null,remaining_tokens);
var G__22020 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22019;
name_tokens = G__22020;
continue;
} else {
...
var vec__22023 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22023,(0),null);
var arity = cljs.core.nth.call(null,vec__22023,(1),null);
var vec__22026 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22026,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22026,(1),null);
var vec__22029 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22029,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22029,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22029,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22029,(3),null);
...
var vec__22035 = result;
var munged_ns = cljs.core.nth.call(null,vec__22035,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22035,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22035,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22035,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22035,(4),null);
var arity = cljs.core.nth.call(null,vec__22035,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__22039 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__22039,(0),null);
var args = cljs.core.nth.call(null,vec__22039,(1),null);
var vec__22042 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22042,(0),null);
var name = cljs.core.nth.call(null,vec__22042,(1),null);
...
var G__22045 = (arity + (1));
var G__22046 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22047){
var vec__22048 = p__22047;
var arity = cljs.core.nth.call(null,vec__22048,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22048,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22051_SHARP_){
return cljs.core.get.call(null,arities,p1__22051_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__22052_SHARP_){
return cljs.core.drop.call(null,(2),p1__22052_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22055){
var vec__22056 = p__22055;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22056,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22053){
var G__22054 = cljs.core.first.call(null,seq22053);
var seq22053__$1 = cljs.core.next.call(null,seq22053);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22054,seq22053__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22064__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22064__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22064__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22064__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22065 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22065,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22065,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22065,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22065,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22065,(4),null);
var arity = cljs.core.nth.call(null,vec__22065,(5),null);
...
var G__22070 = (obj[cljs.core.first.call(null,path)]);
var G__22071 = cljs.core.rest.call(null,path);
obj = G__22070;
path = G__22071;
continue;
} else {
...
var _STAR_ = (function (accum,p__22072){
var vec__22073 = p__22072;
var bit = cljs.core.nth.call(null,vec__22073,(0),null);
var protocol = cljs.core.nth.call(null,vec__22073,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22076){
var vec__22077 = p__22076;
var ns = cljs.core.nth.call(null,vec__22077,(0),null);
var name = cljs.core.nth.call(null,vec__22077,(1),null);
var selector = cljs.core.nth.call(null,vec__22077,(2),null);
...
var post_process = (function (p__22081){
var vec__22082 = p__22081;
var munged_name = cljs.core.nth.call(null,vec__22082,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22082,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22080_SHARP_){
return (obj[cljs.core.first.call(null,p1__22080_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1628173102596
