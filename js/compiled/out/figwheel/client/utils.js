...
return (new CustomEvent(event_name,(function (){var obj28018 = ({"detail":data});
return obj28018;
})()));
} else {
...
var f = (function (){var pred__28025 = cljs.core._EQ_;
var expr__28026 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28025.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28026))){
return (function (p1__28019_SHARP_){
return console.warn(p1__28019_SHARP_);
});
} else {
if(cljs.core.truth_(pred__28025.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28026))){
return (function (p1__28020_SHARP_){
return console.debug(p1__28020_SHARP_);
});
} else {
if(cljs.core.truth_(pred__28025.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28026))){
return (function (p1__28021_SHARP_){
return console.error(p1__28021_SHARP_);
});
} else {
return (function (p1__28022_SHARP_){
return console.log(p1__28022_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28029){
...
f.call(null,val,(function (p1__28032_SHARP_){
return new_def.callback(p1__28032_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__28033){
var vec__28034 = p__28033;
var ky = cljs.core.nth.call(null,vec__28034,(0),null);
var v = cljs.core.nth.call(null,vec__28034,(1),null);
...
}catch (e28039){if((e28039 instanceof Error)){
var e = e28039;
return not_found;
} else {
throw e28039;
...
//# sourceMappingURL=utils.js.map?rel=1628173109937
