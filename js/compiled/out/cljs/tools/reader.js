...
var G__24236 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24236;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24237 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24237,ch);
...
if(("\\" === ch__$1)){
var ch_24238__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24238__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24238__$2);
} else {
}

var G__24239 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__24239;
continue;
}
}
...
var start_line = cljs.core.nth.call(null,vec__24247,(0),null);
var start_column = cljs.core.nth.call(null,vec__24247,(1),null);
...
var G__24250 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24250;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__24251 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__24252 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__24252);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__24251);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__24253 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24253,(0),null);
var start_column = cljs.core.nth.call(null,vec__24253,(1),null);
...
var vec__24256 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24256,(0),null);
var end_column = cljs.core.nth.call(null,vec__24256,(1),null);
...
var vec__24259 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24259,(0),null);
var start_column = cljs.core.nth.call(null,vec__24259,(1),null);
...
var vec__24262 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24262,(0),null);
var end_column = cljs.core.nth.call(null,vec__24262,(1),null);
...
var vec__24265 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24265,(0),null);
var start_column = cljs.core.nth.call(null,vec__24265,(1),null);
...
var vec__24268 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24268,(0),null);
var end_column = cljs.core.nth.call(null,vec__24268,(1),null);
...
var sb = (function (){var G__24271 = (new goog.string.StringBuffer());
G__24271.append(initch);
...
var G__24273 = (function (){var G__24272 = sb;
G__24272.append(ch);

return G__24272;
})();
var G__24274 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24273;
ch = G__24274;
continue;
}
...
switch (G__24277) {
case "\\":
var G__24281 = (function (){var G__24278 = sb;
G__24278.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24278;
})();
var G__24282 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24281;
ch = G__24282;
continue;
...
break;
default:
var G__24283 = (function (){var G__24279 = sb;
G__24279.append(ch);

return G__24279;
})();
var G__24284 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24283;
ch = G__24284;
continue;
...
var vec__24285 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24285,(0),null);
var end_column = cljs.core.nth.call(null,vec__24285,(1),null);
...
var vec__24288 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24288,(0),null);
var column = cljs.core.nth.call(null,vec__24288,(1),null);
...
var vec__24293 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24293,(0),null);
var column = cljs.core.nth.call(null,vec__24293,(1),null);
...
var vec__24298 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24298,(0),null);
var column = cljs.core.nth.call(null,vec__24298,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__24303 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24303,(0),null);
var start_column = cljs.core.nth.call(null,vec__24303,(1),null);
...
var vec__24306 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24306,(0),null);
var end_column = cljs.core.nth.call(null,vec__24306,(1),null);
...
var G__24309 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24309,true,null,opts,pending_forms);
...
var G__24310 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24310)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24310)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24310)){
...
var _STAR_suppress_read_STAR__orig_val__24311 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24312 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24312);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24311);
}});
...
var G__24313 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24313,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24313,rdr,first_line);
...
var G__24317 = matched;
var G__24318 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24317;
finished = G__24318;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__24319 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24320 = (function (){var or__4126__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24320);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24319);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__24321 = cljs.tools.reader.arg_env;
var arg_env_temp_val__24322 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__24322);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24323 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24323,"(");
...
var G__24324 = (i + (1));
var G__24325 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4126__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__24321);
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24326 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24326);
...
var G__24327 = cljs.core.next.call(null,s__$1);
var G__24328 = ret;
s__$1 = G__24327;
r = G__24328;
continue;
...
var G__24329 = cljs.core.next.call(null,s);
var G__24330 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24329;
key_vals = G__24330;
continue;
} else {
...
var gensym_env_orig_val__24335 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__24336 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__24336);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__24335);
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24337 = token;
var G__24337__$1 = (((G__24337 == null))?null:cljs.core.subs.call(null,G__24337,(1)));
var G__24337__$2 = (((G__24337__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24337__$1));
var G__24337__$3 = (((G__24337__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24337__$2));
var G__24337__$4 = (((G__24337__$3 == null))?null:cljs.core.symbol.call(null,G__24337__$3));
if((G__24337__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24337__$4);
}
})():(function (){var G__24338 = token;
var G__24338__$1 = (((G__24338 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24338));
if((G__24338__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24338__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24349,reader){
...
var eof = cljs.core.get.call(null,map__24350__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1628173107139
